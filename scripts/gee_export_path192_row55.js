/*
 * GEE Export Script — Third Landsat Scene for Lagos East Gap
 * ============================================================
 *
 ...
 * Path 192, Row 55 — the scene that overlaps the eastern gap of the
 * Lagos State boundary (Epe, Ibeju-Lekki area).
 *
 * After export finishes (~15-30 min), download from Google Drive
 * folder "urban_heat_intelligence" and place files into:
 *     data/raw/imagery/LC09_192055_YYYYMMDD/
 */

// ---------- CONFIGURATION ----------

// Lagos State boundary (WGS84) with a 30 km buffer.
...
if (bestImage === null) {
  ...
  // Submit export (no task.start() needed in Code Editor).
  ...
  print('Go to the Tasks tab (right panel) to monitor.');
  print('');
  print('NEXT STEPS:');
  print('1. Click Run on the task in the Tasks tab');
  print('2. Wait for export to finish (~15-30 min)');
  print('3. Download from Google Drive/urban_heat_intelligence/');
  print('4. Place the .tif file in: data/raw/imagery/' + description + '/');
  print('5. Tell me when ready — I will mosaic all three scenes');
}
